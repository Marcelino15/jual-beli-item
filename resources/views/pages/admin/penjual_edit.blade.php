...
<div class="container-fluid">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ route('penjual-update', $item->id) }}" method="post">
                @method('PUT')
                @csrf
                <div class="row">
                ...
                <a href="{{route('list-penjual')}}" class="btn btn-primary btn-sm text-uppercase">kembali</a>
            </form>
        </div>
    </div>
</div>
