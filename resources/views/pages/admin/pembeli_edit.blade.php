...
<div class="container-fluid">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item">Pembeli</li>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ route('pembeli-update', $item->id) }}" method="post">
                @method('PUT')
                @csrf
                <div class="row">
                ...
                <a href="{{route('list-pembeli')}}" class="btn btn-primary btn-sm text-uppercase">kembali</a>
            </form>
        </div>
    </div>
</div>
